"""
Seed data for static content (impact stories, news, about, causes)
"""

from models import ImpactStory, NewsHighlight, AboutContent, CauseCategory, AggregatedImpact
...
# Impact Stories from real beneficiaries
IMPACT_STORIES = [
    ImpactStory(
        id='story-1',
        name='Priya Sharma',
        ...
        fund_slug='armed-forces-flag-day-fund',
        image=IMAGES['soldier_family']
    ),
    ImpactStory(
        id='story-2',
        name='Meera Devi',
        ...
        fund_slug='bharat-ke-veer',
        image=IMAGES['flag_soldiers']
    ),
    ImpactStory(
        id='story-3',
        ...
        fund_slug='national-defence-fund',
        image=IMAGES['wheelchair']
    )
]

# News Highlights based on actual events from MD files
NEWS_HIGHLIGHTS = [
    NewsHighlight(
        id='news-1',
        title='Armed Forces Flag Day 2024: Record Contributions',
        date='2024-12-07',
        excerpt='Flag Day 2024 witnessed record corporate and public participation, with REC Limited contributing ₹15 crores for education of 12,500 children of ex-servicemen.',
        fund_slug='armed-forces-flag-day-fund',
        image=IMAGES['police_salute']
    ),
    NewsHighlight(
        id='news-2',
...
CAUSE_CATEGORIES = [
    CauseCategory(
        ...
        icon='GraduationCap',
        related_fund_slugs=['armed-forces-flag-day-fund', 'national-defence-fund']
    ),
    CauseCategory(
        id='medical',
        title='Medical Aid',
        ...
        icon='Heart',
        related_fund_slugs=['armed-forces-flag-day-fund', 'bharat-ke-veer']
    ),
    CauseCategory(
        id='widows',
        title='War Widows',
